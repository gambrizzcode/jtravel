...
<head>
	...
	<title>Jtravel Admin Wisata</title>
...
$(document).ready(function() {
	...
	$('#refresh').click(function() {
		window.location="adminWisata.php";
	});
	...
	$('#simpan').click(function() {
		...
		var ket = $('#ket').val();
		$.ajax({
			url: 'simpanWisata.php',
			type: 'GET',
			data: "id_wisata="+id_wisata+"&nama="+nama+"&alamat="+alamat+"&jenis="+jenis+"&jarak="+jarak+"&tiket="+tiket+"&telp="+telp+"&gambar="+gambar+"&status="+status+"&ket="+ket,
...
<div class="wrapper">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="modal-title"><span class="fa fa-globe"></span> TAMBAH DESTINASI WISATA</h3>
					</div>
					<div class="modal-body">
						<form id="uploadForm" action="simpanWisata.php" enctype="multipart/form-data" method="post">
						<input type="text" placeholder="KODE.." id="kode" class="form-control" value="<?php $krj->kodeWisata(); ?>"><br>
						...
						<input type="text" placeholder="JARAK.." id="jarak" class="form-control"><br>
						<input type="text" placeholder="TIKET.." id="tiket" class="form-control"><br>
						<input type="text" placeholder="TELP.." id="telp" class="form-control"><br>
						<label>GAMBAR</label><input type="file" id="gambar" name="gambar"><br>
	...
	<div class="col-xs-12">
			...
			<div class="box-header">
				<h3><i class="fa fa-globe"></i> Data Wisata <button style="margin-right:10px" type="button" id="tambah" class="btn btn-info pull-right" data-toggle="modal" data-target="#modalku">TAMBAH <span class="glyphicon glyphicon-file"></span></button>
			...
			<table class="table table-default table-striped table-responsive table-condensed" id="wisata">
				<thead>
				<tr class="info">
					<th>#</th>
					<th>ID WISATA</th>
			...
			<tr>
				...
				<td><?php echo $isi[4]." KM"; ?></td>
				<td><?php echo "Rp. ".number_format($isi[5],0,",","."); ?></td>
				<td><?php echo $isi[6]; ?></td>
				<td><?php echo $isi[7]; ?></td>
				<td><?php if ($isi[8] == 0) {echo "<span class='label label-danger'>TUTUP</span>";}else{echo "<span class='label label-success'>BUKA</span>";} ?></td>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body" align="center">
												...
												<a href="hapusWisata.php?id_wisata=<?php echo $isi[0]; ?>"><button type="button" class="btn btn-danger"><span class="fa fa-trash"></span> HAPUS</button></a>
